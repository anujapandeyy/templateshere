import {
  ...
  const Template = () => {
    return (
      <Html lang="en">
        <Head>
          <title>Mozohack Registration Reminder</title>
          <Font
            fontFamily="Roboto"
                ...
                <Container className="p-4">
                  <Section>
                    <Text className="text-black text-lg">
                      As the registration deadline approaches, now is the perfect
                      time to secure your spot and be a part of this dynamic and
                      collaborative experience. <br /> If you've already registered,
                      thank you for being a part of MOZOHACK - get ready for an
                      unforgettable experience!<br /> More details on MOZOHACK can be
                      found here at:<br /> <a href="https://events.srmkzilla.net/">https://events.srmkzilla.net/</a>. <br />Once you’ve
                      registered, be sure to keep up with MOZOHACK updates on our
                      Discord community server at: <a href="http://community.srmkzilla.net/">http://community.srmkzilla.net/</a>
                      <br />
                      Regards, <br />
                      SRMKZILLA
                    </Text>
